...
SAMPLES=1000
SAVE_DIR=/data1/yw/clip_distill/RobustVLM-main/clip_data # TODO
mkdir -p "$SAVE_DIR"
python -m clip_benchmark.cli eval --dataset_root "https://hf-mirror.com/datasets/clip-benchmark/wds_{dataset_cleaned}/tree/main" --dataset benchmark/datasets.txt \
